...
namespace Maticsoft.DAL
{
	...
	public partial class Member
	{
		...
		public int Add(Maticsoft.Model.Member model)
		{
			...
			strSql.Append("MemberName,MemberPhone,MemberPhone1,Integral,address,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Integral", SqlDbType.VarChar,100),
			...
			parameters[2].Value = model.MemberPhone1;
			...
			parameters[9].Value = model.BY4;
			parameters[10].Value = model.BY5;
			parameters[11].Value = model.BY6;
			parameters[12].Value = model.BY7;
		...
		public Maticsoft.Model.Member GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,MemberName,MemberPhone,MemberPhone1,Integral,address,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 from Member ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Maticsoft.Model.Member DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				if(row["Integral"]!=null)
				{
					model.Integral=row["Integral"].ToString();
				}
				if(row["address"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,MemberName,MemberPhone,MemberPhone1,Integral,address,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,MemberName,MemberPhone,MemberPhone1,Integral,address,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
			strSql.Append(" FROM Member ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
