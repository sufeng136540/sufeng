...
namespace Maticsoft.DAL
{
	...
	public partial class Commoditytab
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Commoditytab"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Commoditytab");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.Commoditytab model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Commoditytab(");
			strSql.Append("category,Name,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.Commoditytab model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Commoditytab set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Commoditytab ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Commoditytab GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,category,Name,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 from Commoditytab ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Commoditytab DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Commoditytab model=new Maticsoft.Model.Commoditytab();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,category,Name,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
			strSql.Append(" FROM Commoditytab ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,category,Name,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
			strSql.Append(" FROM Commoditytab ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Commoditytab T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Commoditytab";
