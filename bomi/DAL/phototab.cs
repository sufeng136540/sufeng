...
namespace Maticsoft.DAL
{
	...
	public partial class phototab
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "phototab"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from phototab");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.phototab model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into phototab(");
			strSql.Append("Photourl,beizhu,By1,By2,By3,By4,By5,By6,By7)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.phototab model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update phototab set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from phototab ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.phototab GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,Photourl,beizhu,By1,By2,By3,By4,By5,By6,By7 from phototab ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.phototab DataRowToModel(DataRow row)
		{
			Maticsoft.Model.phototab model=new Maticsoft.Model.phototab();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Photourl,beizhu,By1,By2,By3,By4,By5,By6,By7 ");
			strSql.Append(" FROM phototab ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,Photourl,beizhu,By1,By2,By3,By4,By5,By6,By7 ");
			strSql.Append(" FROM phototab ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from phototab T ");
