...
namespace Maticsoft.DAL
{
	...
	public partial class Staffmember
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Staffmember"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Staffmember");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.Staffmember model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Staffmember(");
			strSql.Append("Staffname,information,departmentID,Positionid,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7)");
			strSql.Append(" values (");
			strSql.Append("@Staffname,@information,@departmentID,@Positionid,@Beizhu,@BY1,@BY2,@BY3,@BY4,@BY5,@BY6,@BY7)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@Staffname", SqlDbType.VarChar,100),
					new SqlParameter("@information", SqlDbType.VarChar,100),
			...
			parameters[0].Value = model.Staffname;
			parameters[1].Value = model.information;
			...
			parameters[10].Value = model.BY6;
			parameters[11].Value = model.BY7;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.Staffmember model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Staffmember set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Staffmember ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Staffmember GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,Staffname,information,departmentID,Positionid,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 from Staffmember ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Staffmember DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Staffmember model=new Maticsoft.Model.Staffmember();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Staffname,information,departmentID,Positionid,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,Staffname,information,departmentID,Positionid,Beizhu,BY1,BY2,BY3,BY4,BY5,BY6,BY7 ");
			strSql.Append(" FROM Staffmember ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Staffmember T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Staffmember";
