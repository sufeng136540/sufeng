...
namespace Maticsoft.DAL
{
	...
	public partial class Position
	{
		...
		public Maticsoft.Model.Position GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,beizhu,By1,By2,By3,By4,By5,By6,By7 from Position ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Position DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Position model=new Maticsoft.Model.Position();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,beizhu,By1,By2,By3,By4,By5,By6,By7 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,name,beizhu,By1,By2,By3,By4,By5,By6,By7 ");
			strSql.Append(" FROM Position ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
