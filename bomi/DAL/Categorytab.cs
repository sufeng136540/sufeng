...
namespace Maticsoft.DAL
{
	...
	public partial class Categorytab
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Categorytab"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Categorytab");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Categorytab ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Categorytab ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Categorytab T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Categorytab";
