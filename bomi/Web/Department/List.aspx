<%@ Page Title="Department" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Department.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="departmentname" HeaderText="departmentname" SortExpression="departmentname" ItemStyle-HorizontalAlign="Center"  /> 
