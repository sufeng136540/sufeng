<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bumenlist.aspx.cs" Inherits="Maticsoft.Web.xitong.bumenlist" %>
...
<body>
    ...
    <div id="popDiv1" class="mydiv" style="display:none;">
		  <div class="biaot">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加部门</h1><h2><a href="javascript:closeDiv1()"><img src="../images/fenlei/dialog_closebtn.gif" alt="CPU"  onMouseOver="this.src='../images/fenlei/dialog_closebtn_over.gif'" onMouseOut="this.src='../images/fenlei/dialog_closebtn.gif'" align="right" /></a>&nbsp;&nbsp;&nbsp;</h2>
		  <div class="js1 zhong">
    ...
    <div id="popDiv2" class="mydiv" style="display:none;">
		  <div class="biaot">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修改部门</h1><h2><a href="javascript:closeDiv2()"><img src="../images/fenlei/dialog_closebtn.gif" alt="CPU"  onMouseOver="this.src='../images/fenlei/dialog_closebtn_over.gif'" onMouseOut="this.src='../images/fenlei/dialog_closebtn.gif'" align="right" /></a>&nbsp;&nbsp;&nbsp;</h2>
		  <div class="js1 zhong">
		 <table width="98%" border="0" cellpadding="0" cellspacing="1">
          <tr class="a2875d3">
		     <td width="10%">部门ID:</td>
...
<table width="98%" border="0" align="left" cellpadding="0" cellspacing="1">
  <tr>
    <td height="33" colspan="5" class="tabaa"><asp:Image ID="Image1" runat="server" src="../images/bianti_jiao.jpg" width="34" height="33" align="left" /><span class="biaoti1">部门信息</span></td>
  </tr>
    
  <tr>
  <td height="33" colspan="4" align="left"  > &nbsp;&nbsp; 部门名称：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;
  ...
  <tr class="a2875d3">
    ...
    <td width="10%" height="30" align="center"><asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Red" onclick="LinkButton3_Click">添加部门</asp:LinkButton></td>
	 </tr>
