<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tupian.aspx.cs" Inherits="Maticsoft.Web.xinxi.tupian" %>
...
<body>
    ...
    <div id="popDiv1" class="mydiv" style="display:none;">
		  <div class="biaot">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加图片</h1><h2><a href="javascript:closeDiv1()"><img src="../images/fenlei/dialog_closebtn.gif" alt="CPU"  onmouseover="this.src='../images/fenlei/dialog_closebtn_over.gif'" onmouseout="this.src='../images/fenlei/dialog_closebtn.gif'" align="right" /></a>&nbsp;&nbsp;&nbsp;</h2>
		  <div class="js1 zhong">
    ...
    <div id="popDiv2" class="mydiv" style="display:none;">
		 ...
		 <tr class="a2875d3">
          ...
          <asp:ImageButton ID="ImageButton2" runat="server"  src="../images/fenlei/queren.jpg" />
          </a></p>
		  </div>
</div>
...
<table width="98%" border="0" align="left" cellpadding="0" cellspacing="1">
  ...
  <tr class="a2875d3">
    ...
    <td width="10%" height="30" align="center"><asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Red" onclick="LinkButton3_Click">上传图片</asp:LinkButton></td>
	 </tr>
