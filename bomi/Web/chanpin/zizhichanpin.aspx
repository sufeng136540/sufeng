<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zizhichanpin.aspx.cs" Inherits="Maticsoft.Web.canpinTAB.zizhicanpin" %>
...
<body>
    ...
    <div id="popDiv1" class="mydiv" style="display:none;">
		  <div class="biaot">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加自制产品</h1><h2><a href="javascript:closeDiv1()"><img src="../images/fenlei/dialog_closebtn.gif" alt="CPU"  onmouseover="this.src='../images/fenlei/dialog_closebtn_over.gif'" onmouseout="this.src='../images/fenlei/dialog_closebtn.gif'" align="right" /></a>&nbsp;&nbsp;&nbsp;</h2>
		  <div class="js1 zhong">
    ...
    <div id="popDiv2" class="mydiv" style="display:none;">
		  <div class="biaot">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;修改自制商品</h1><h2><a href="javascript:closeDiv2()"><img src="../images/fenlei/dialog_closebtn.gif" alt="CPU"  onmouseover="this.src='../images/fenlei/dialog_closebtn_over.gif'" onmouseout="this.src='../images/fenlei/dialog_closebtn.gif'" align="right" /></a>&nbsp;&nbsp;&nbsp;</h2>
		  <div class="js1 zhong">
		 <table width="98%" border="0" cellpadding="0" cellspacing="1">
          <tr class="a2875d3">
		     <td width="10%">产品ID:</td>
...
<table width="98%" border="0" align="left" cellpadding="0" cellspacing="1">
  <tr>
    <td height="33" colspan="6" class="tabaa"><asp:Image ID="Image1" runat="server" src="../images/bianti_jiao.jpg" width="34" height="33" align="left" /><span class="biaoti1">自制商品信息</span></td>
  </tr>
    
  <tr>
  <td height="33" colspan="6" align="left"  > &nbsp;&nbsp; 自制商品名称：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;
  ...
  <tr class="a2875d3">
    ...
    <td width="25%" align="center">商品说明</td>
	<td width="35%" align="center">备注</td>
    <td width="10%" height="30" align="center"><asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Red" onclick="LinkButton3_Click">添加自制商品</asp:LinkButton></td>
	 </tr>
	   ...
	   <tr>
            ...
            <td  align="center"><%# Eval("Comment")%></td>
