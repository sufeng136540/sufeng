<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhiyuandanjuselect.aspx.cs" Inherits="Maticsoft.Web.danju.zhiyuandanjuselect" %>
...
<table width="96%"  align="left" cellpadding="0" cellspacing="1">
  <tr>
    <td height="33" colspan="3" class="tabaa"><img src="../images/bianti_jiao.jpg" alt="CPU" width="34" height="33" align="left" /><span class="biaoti1">职员单据详情</span></td>
  </tr>
   <tr>
    <td height="50" colspan="3" align="right" valign="middle" ><span class="y" style="padding-right:20px;">定单编号：<asp:Label ID="Label1" runat="server" Text=""></asp:Label></span></td>
  </tr>
 <tr>
...
<br />
 ...
 <td colspan="2" style="padding:10px;">
     外购商品备注：<br />
<br />
     <asp:Label ID="Label15" runat="server" Height="150px"></asp:Label>
 </td>
 </tr>
 <tr>
    <td colspan="2" style="padding:10px;">客户姓名：<asp:Label ID="Label8" runat="server"></asp:Label>
    ...
    <td rowspan="2" style="padding:10px;">赠品：<br /><br />
 ...
 <td colspan="2" style="padding:10px;">送货日期：<asp:Label ID="Label12" runat="server"></asp:Label>
     ...
     &nbsp;&nbsp; 付款状况：<asp:Label ID="Label23" runat="server"></asp:Label>
     </td>
 </tr>
  <tr class="a2875d3">
