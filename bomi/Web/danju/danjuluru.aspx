<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="danjuluru.aspx.cs" Inherits="Maticsoft.Web.danju.danjuluru" %>
...
<script type="text/javascript">
    function showDiv6() {
        document.getElementById('popDiv6').style.display = 'block';
        document.getElementById('bg1').style.display = 'block';
    }
    function closeDiv6() {
        document.getElementById('popDiv6').style.display = 'none';
        document.getElementById('bg1').style.display = 'none';
    }
</script>
</head>
...
<table width="96%"  align="left" cellpadding="0" cellspacing="1">
  <tr>
    <td height="33" colspan="3" class="tabaa"><img src="../images/bianti_jiao.jpg" alt="CPU" width="34" height="33" align="left" /><span class="biaoti1">单据录入</span></td>
  </tr>
   <tr>
...
<asp:TextBox ID="TextBox5" runat="server" TextMode="MultiLine" Width="95%" Height="150px"></asp:TextBox>
 ...
 <tr>
    <td colspan="2" style="padding:10px;">客户姓名：<asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>&nbsp; 电话1：<asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>&nbsp; 电话2：<asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
        客户等级： <asp:DropDownList ID="DropDownList9" runat="server" >
                        <asp:ListItem Value="0" Text="0">选择客户等级</asp:ListItem>
                        <asp:ListItem Value="1" Text="1">A级客户</asp:ListItem>
                        <asp:ListItem Value="2" Text="2">B级客户</asp:ListItem>
                        <asp:ListItem Value="3" Text="3">C级客户</asp:ListItem>
                    </asp:DropDownList><br /><br />客户地址：<asp:TextBox ID="TextBox10" runat="server" Width="60%"></asp:TextBox></td>
 ...
 <td colspan="2" style="padding:10px;">送货日期：<asp:TextBox ID="TextBox11" runat="server" onClick="laydate()" ></asp:TextBox>&nbsp;总金额：<asp:TextBox ID="TextBox12" runat="server"></asp:TextBox>&nbsp;
     已付款：<asp:TextBox ID="TextBox13" runat="server"></asp:TextBox>&nbsp;付款状况： 
  ...
  <tr class="a2875d3">
    <td height="50" colspan="3"align="center" valign="middle" style=" padding:5px;" >
        <asp:Button ID="Button1" runat="server" Text="录入单据" onclick="Button1_Click" /></td>
  </tr>
  </table>
	</div>
