<%@ Page Title="Operator" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Operator.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="BranchID" HeaderText="BranchID" SortExpression="BranchID" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="JurisdictionID" HeaderText="JurisdictionID" SortExpression="JurisdictionID" ItemStyle-HorizontalAlign="Center"  /> 
