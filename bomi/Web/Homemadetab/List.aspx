<%@ Page Title="Homemadetab" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Homemadetab.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Photourl" HeaderText="Photourl" SortExpression="Photourl" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Comment" HeaderText="Comment" SortExpression="Comment" ItemStyle-HorizontalAlign="Center"  /> 
