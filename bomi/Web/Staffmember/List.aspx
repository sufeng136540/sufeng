<%@ Page Title="Staffmember" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Staffmember.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="information" HeaderText="information" SortExpression="information" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Positionid" HeaderText="Positionid" SortExpression="Positionid" ItemStyle-HorizontalAlign="Center"  /> 
